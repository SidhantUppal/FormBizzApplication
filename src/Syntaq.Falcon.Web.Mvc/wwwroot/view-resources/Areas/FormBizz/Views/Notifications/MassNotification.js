...
(function () {
    $(function () {
        ...
        var _createMassNotificationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'FormBizz/Notifications/CreateMassNotificationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Notifications/_CreateMassNotificationModal.js',
