(function () {
  ...
  app.modals.PermissionTreeModal.create = function (options) {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Common/PermissionTreeModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Common/Modals/_PermissionTreeModal.js',
