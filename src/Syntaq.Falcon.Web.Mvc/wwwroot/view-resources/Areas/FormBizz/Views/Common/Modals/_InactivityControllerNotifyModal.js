(function () {
  ...
  app.modals.InactivityControllerNotifyModal.create = function () {
    var modal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Common/InactivityControllerNotifyModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/FormBizz/Views/Common/Modals/_InactivityControllerNotifyModal.js',
