...
namespace FormBizz.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : FormBizzServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "FormBizz";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + FormBizzConsts.Currency;
        }
        ...
        private async Task<StripeIdResponse> CreatePlanAsync(string planId, decimal amount, string interval, string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = FormBizzConsts.Currency
            });
