$(function () {
  ...
  var _addWidgetModal = new app.ModalManager({
    viewUrl: abp.appPath + 'FormBizz/' + $('#DashboardName').val() + '/AddWidgetModal',
    scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/CustomizableDashboard/_AddWidgetModal.js',
