(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Languages/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Languages/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  document.location.href = abp.appPath + 'FormBizz/Languages/Texts?languageName=' + data.record.name;
                },
              },
              {
