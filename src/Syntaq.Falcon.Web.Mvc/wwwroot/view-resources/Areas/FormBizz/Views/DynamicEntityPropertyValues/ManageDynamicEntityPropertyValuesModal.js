(function () {
  ...
  app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/FormBizz/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
