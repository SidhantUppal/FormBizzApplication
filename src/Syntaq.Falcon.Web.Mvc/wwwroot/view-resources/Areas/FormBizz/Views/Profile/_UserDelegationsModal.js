(function ($) {
  app.modals.UserDelegationsModal = function () {
    ...
    var _createNewUserDelegationModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Profile/CreateNewUserDelegationModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Profile/_CreateNewUserDelegationModal.js',
