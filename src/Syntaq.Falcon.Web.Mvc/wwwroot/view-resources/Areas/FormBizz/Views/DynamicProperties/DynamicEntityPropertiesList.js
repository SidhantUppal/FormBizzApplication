(function () {
  $(function () {
    ...
    var _selectAnEntity = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/DynamicProperty/SelectAnEntityModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/DynamicProperties/_SelectAnEntityModal.js',
    ...
    var _manageDynamicEntityPropertyModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/DynamicEntityProperty/ManageModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/FormBizz/Views/_Bundles/dynamic-entity-properties-manage-modal.min.js',
