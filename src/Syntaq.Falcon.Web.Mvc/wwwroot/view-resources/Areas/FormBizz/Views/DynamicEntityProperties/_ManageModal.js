(function () {
  app.modals.ManageDynamicEntityPropertyModal = function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/DynamicEntityProperty/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/DynamicEntityProperties/_CreateModal.js',
