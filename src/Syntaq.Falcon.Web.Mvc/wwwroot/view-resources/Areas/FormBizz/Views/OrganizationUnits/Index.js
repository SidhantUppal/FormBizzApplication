(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/OrganizationUnits/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/OrganizationUnits/_CreateModal.js',
      modalClass: 'CreateOrganizationUnitModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/OrganizationUnits/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/OrganizationUnits/_EditModal.js',
      modalClass: 'EditOrganizationUnitModal',
    });

    var _addUserModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/OrganizationUnits/AddMemberModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/OrganizationUnits/_AddMemberModal.js',
    ...
    var _addRoleModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/OrganizationUnits/AddRoleModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/OrganizationUnits/_AddRoleModal.js',
