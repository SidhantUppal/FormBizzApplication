...
namespace FormBizz.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FormBizzAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FormBizzDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FormBizzConsts.ConnectionStringName}", constring);
        }
