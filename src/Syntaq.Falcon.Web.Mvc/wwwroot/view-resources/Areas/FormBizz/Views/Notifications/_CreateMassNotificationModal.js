(function ($) {
    app.modals.CreateMassNotificationModal = function () {
        ...
        var _userLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'FormBizz/Notifications/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Notifications/_UserLookupTableModal.js',
            modalClass: 'UserLookupTableModal',
        });

        var _organizationUnitLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'FormBizz/Notifications/OrganizationUnitLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Notifications/_OrganizationUnitLookupTableModal.js',
        ...
        $('#CreateMassNotificationModal_TargetNotifiers').change(function () {
            ...
            var isSMSSelected = selectedTargetNotifiers.indexOf("FormBizz.Notifications.SmsRealTimeNotifier") >= 0;
