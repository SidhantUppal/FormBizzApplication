(function ($) {
  $(function () {
    ...
    var mySettingsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Profile/MySettingsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Profile/_MySettingsModal.js',
    ...
    var changePasswordModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Profile/ChangePasswordModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Profile/_ChangePasswordModal.js',
    ...
    var changeProfilePictureModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Profile/ChangePictureModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Profile/_ChangePictureModal.js',
    ...
    var manageLinkedAccountsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Profile/LinkedAccountsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Profile/_LinkedAccountsModal.js',
    ...
    var userDelegationsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Profile/UserDelegationsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Profile/_UserDelegationsModal.js',
