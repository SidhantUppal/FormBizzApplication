(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/DynamicProperty/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/DynamicProperties/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditDynamicPropertyModal',
      cssClass: 'scrollable-modal',
    });

    var _manageValuesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/DynamicProperty/ManageValuesModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/FormBizz/Views/_Bundles/dynamic-properties-manage-values.min.js',
