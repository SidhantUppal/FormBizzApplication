    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var imageUrl = abp.appPath + 'FormBizz/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'FormBizz/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
                var uploadedFileMsg =
                    '<a href="' +
                    fileUrl +
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'FormBizz/Chat/UploadFile';
