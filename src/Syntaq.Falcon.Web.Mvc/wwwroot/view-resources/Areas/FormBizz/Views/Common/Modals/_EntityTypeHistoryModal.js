(function () {
  app.modals.EntityTypeHistoryModal = function () {
    ...
    function showEntityChangeDetails(entityChange) {
      var entityChangeDetailModal = new app.ModalManager({
        viewUrl: abp.appPath + 'FormBizz/AuditLogs/EntityChangeDetailModal',
  ...
  app.modals.EntityTypeHistoryModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Common/EntityTypeHistoryModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Common/Modals/_EntityTypeHistoryModal.js',
