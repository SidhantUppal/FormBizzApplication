...
(function ($) {
  app.UserNotificationHelper = (function () {
    return function () {
      ...
      /* Example:
            abp.notifications.messageFormatters['FormBizz.MyNotificationDataType'] = function(userNotification) {
      ...
      function getUrl(userNotification) {
        switch (userNotification.notification.notificationName) {
          case 'App.NewUserRegistered':
            return '/FormBizz/users?filterText=' + userNotification.notification.data.properties.emailAddress;
          case 'App.NewTenantRegistered':
            return '/FormBizz/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
      ...
      var openSettingsModal = function () {
        new app.ModalManager({
          viewUrl: abp.appPath + 'FormBizz/Notifications/SettingsModal',
          scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Notifications/_SettingsModal.js',
