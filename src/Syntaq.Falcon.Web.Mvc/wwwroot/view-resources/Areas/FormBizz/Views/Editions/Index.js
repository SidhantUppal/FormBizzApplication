(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Editions/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Editions/_CreateModal.js',
      modalClass: 'CreateEditionModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Editions/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Editions/_EditModal.js',
      modalClass: 'EditEditionModal',
    });

    var _moveTenantsToAnotherEditionModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Editions/MoveTenantsToAnotherEdition',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
