(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'FormBizz.MultiTenancy.Tenant';
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Tenants/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Tenants/_CreateModal.js',
      modalClass: 'CreateTenantModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Tenants/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Tenants/_EditModal.js',
      modalClass: 'EditTenantModal',
    });

    var _featuresModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/Tenants/FeaturesModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/Tenants/_FeaturesModal.js',
