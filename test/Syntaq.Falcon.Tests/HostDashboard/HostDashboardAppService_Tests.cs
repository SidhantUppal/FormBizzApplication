...
using FormBizz.MultiTenancy.HostDashboard;
...
namespace FormBizz.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(FormBizzDbContext context, SubscriptionPayment subscriptionPayment)
        {
