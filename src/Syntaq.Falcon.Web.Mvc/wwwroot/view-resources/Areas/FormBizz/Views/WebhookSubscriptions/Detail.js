(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'FormBizz/WebhookSubscription/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/FormBizz/Views/WebhookSubscriptions/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  window.location = '/FormBizz/WebhookSubscription/WebhookEventDetail/' + data.record.webhookEventId;
                },
              },
            ],
          },
